...
public class PlatformHome {
	...
	public Platform merge(Platform detachedInstance) {
		...
		try {
			Platform result = (Platform) sessionFactory.getCurrentSession()
	...
	public Platform findById(java.lang.Integer id) {
		...
		try {
			Platform instance = (Platform) sessionFactory.getCurrentSession()
					.get("dto.Platform", id);
			if (instance == null) {
	...
	public List findByExample(Platform instance) {
		log.debug("finding Platform instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("dto.Platform")
